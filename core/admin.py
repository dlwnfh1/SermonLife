...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ("user", "church", "member_role", "can_use_audio_transcriber", "can_manage_attendance", "can_check_attendance", "attendance_only_mode", "points", "streak_days")
    search_fields = ("user__username", "member_role", "church__name", "church__slug")
    list_filter = ("church", "member_role", "can_use_audio_transcriber", "can_manage_attendance", "can_check_attendance", "attendance_only_mode")
    list_editable = ("can_use_audio_transcriber", "can_manage_attendance", "can_check_attendance", "attendance_only_mode")
